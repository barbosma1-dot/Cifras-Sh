...
// Ícone da "logo" do Spotify (círculo + três ondas) — mesmo desenho usado no
// botão de Spotify do ChordViewer.tsx, pra manter a identidade visual igual
// em toda a parte do app que linka pro Spotify.
          ...
          >
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-400 uppercase mb-2 flex items-center gap-1.5">
                    <SpotifyIcon className="w-3.5 h-3.5 text-[#1DB954]" /> Playlist do Spotify
                  </label>
                  <input
                    type="url"
                  ...
                  <div className="pt-4 border-t border-slate-50 space-y-2">
                    ...
                    {repertoire.spotify_playlist_url && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="w-full p-4 bg-[#1DB954]/10 text-[#1DB954] font-bold rounded-2xl text-left flex items-center justify-between hover:bg-[#1DB954]/20 transition-colors"
                      >
                        <span className="flex items-center gap-2">

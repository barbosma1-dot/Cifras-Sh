...
11. ESTRUTURA DO OFÍCIO DIVINO / LITURGIA DAS HORAS (quando a página for claramente um breviário/ofício, reconhecível por cabeçalhos como "Invitatório", "Salmodia", "Leitura breve", "Responsório breve", "Preces", "Cântico evangélico", "Oração" e/ou um título de dia/hora no topo como "I DOMINGO", "I SEGUNDA-FEIRA", "LAUDES", "VÉSPERAS"): trate cada peça com acorde (Hino, cada Salmo, cada Cântico) como um objeto PRÓPRIO e SEPARADO das demais — nunca junte o Hino com o primeiro Salmo, nem um Salmo com o Cântico seguinte, nem o Hino/Salmo/Cântico com o Invitatório, a Leitura breve, o Responsório breve, as Preces ou a Oração (mesmo que estejam na mesma página/imagem sem quebra visual clara, ou que o cabeçalho de uma peça apareça logo colado ao final do texto da peça anterior). Para o "title" de cada peça:
   ...
   QUANDO O PRÓPRIO PDF ROTULA EXPLICITAMENTE CADA VARIANTE COM UM NÚMERO/OPÇÃO (ex.: "HINO — OPÇÃO 1", "HINO — OPÇÃO 2", "HINO — OPÇÃO 3", ou "1ª melodia"/"2ª melodia"): cada rótulo impresso é uma peça DIFERENTE — crie um objeto SEPARADO para cada uma, na ORDEM em que aparecem, SEM PULAR NENHUMA, com o "title" incluindo o rótulo exatamente como impresso (ex.: "Hino — Opção 1", "Hino — Opção 2", "Hino — Opção 3", "Salmo 92(93) — Opção 1", "Salmo 92(93) — Opção 2"). Isso é o oposto de "reimpressão idêntica" (regra 2b): aqui o PDF está oferecendo arranjos musicais DIFERENTES e ALTERNATIVOS da mesma letra/texto litúrgico (acordes diferentes, às vezes tom diferente), e cada um deve continuar disponível como cifra própria no caderno — nunca escolha "a mais completa" e descarte as outras.
